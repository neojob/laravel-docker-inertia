...
@section('content')
    <main class="main">
        <div class="page-header text-center" style="background-image: url('/public/frontCssJsFonts/assets/img/page-header-bg.jpg')">
            <div class="container">
                <h1 class="page-title"><?=$translate::text($section['title'],Config::get('currentLang'))?></h1>
            </div>
        </div>
        <nav aria-label="breadcrumb" class="breadcrumb-nav mb-2">
            <div class="container">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"><?=$translate::text($section['title'],Config::get('currentLang'))?></li>
                </ol>
            </div>
        </nav>

        <div class="page-content section" data-section="<?=$section['id']?>">
            <div class="container">
                <div class="row">
                    <div class="col-lg-9">
                                ...
                                <div class="toolbox-sort">
                                    ...
                                    <div class="select-custom">
                                        <select name="sortby" id="sortby" class="form-control">
                                            <option value="news" selected><?=$translate::text($all_entities[100]['translation'],Config::get('currentLang')) ?></option>
                            ...
                            <div class="widget widget-collapsible">
                                <h3 class="widget-title">
                                    <a data-toggle="collapse" href="#widget-1" role="button" aria-expanded="true" aria-controls="widget-1">
                                        <?=$translate::text($all_entities[45]['translation'],Config::get('currentLang'))?>
                                    </a>
                                </h3>
                                            ...
                                            <?foreach($categories  as $item):?>
                                                <div class="filter-item">
                                                    <div class="custom-control custom-checkbox">
                                                        <a class="cat-links" href="{{URL::to( Config::get('routeLang'))}}/category/<?=$item->alias?>"><?=$translate::text($item->title,Config::get('currentLang'))?></a>
                                                    </div>
                                                    <span class="item-count"><?=\App\Http\Controllers\Front\Categories::getCategoryProductsCount($item->id)?></span>
                                                </div>
                                            <?endforeach?>
                                        </div>
                                    </div>
