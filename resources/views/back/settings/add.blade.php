...
@section('content')
    ...
    <div id="admin-content">
        <div class="container">
            <h2 id="admin-content-title">Add Setting</h2>
            @if ($errors)
            ...
            <div class="jumbotron col-sm-12">
                <form role='form' method="post" enctype="multipart/form-data" class="col-sm-12" action="{{ route('postAdminSettingsAdd') }}">
                    {{ csrf_field() }}
                    ...
                    <div class="form-group col-sm-8">
                        ...
                        <input type="text" class="form-control" id="group"  value="{{ old('group') }}" placeholder="Enter group" name="group">
                    </div>
                        ...
                        <div class="tab-content">
                            @foreach($all_langs as $lang)
                                ...
                                <div class="form-group col-sm-8">
                                    ...
                                    <input type="text" class="form-control" id="value" placeholder="Enter value" value="{{  $translate::text(old('value'),$lang->iso) }}" name="{{ $translate::translatable_key('value',$lang->iso) }}">
                                </div>
                            </div>
