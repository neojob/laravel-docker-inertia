...
@section('content')
    <div id="admin-content">
        <div class="container">
            <h2 id="admin-content-title">Edit Menu</h2>
            @if ($errors)
            ...
            <div class="jumbotron col-sm-12">
                <form role='form' method="post" enctype="multipart/form-data" class="col-sm-12" action="{{ route('postAdminMenusEdit',['id'=>$data['id']])}}">
                    {{ csrf_field() }}
                    ...
                    <div class="form-group col-sm-8">
                        ...
                        <input type="text" class="form-control" id="group_name"  value="{{ $data['group_name'] }}" placeholder="Enter group name" name="group_name">
                    </div>
                    <div class="form-group col-sm-8">
                    ...
                    <div class="form-group col-sm-8">
                        ...
                        <input type="text" class="form-control" id="row"  value="{{ $data['row'] }}" placeholder="Enter row" name="row">
                    </div>
                    <div class="form-group col-sm-8">
