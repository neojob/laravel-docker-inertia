...
@section('content')
    ...
    <div id="admin-content">
        <div class="container">
            <h2 id="admin-content-title">Add Article Type</h2>
            @if ($errors)
            ...
            <div class="jumbotron col-sm-12">
                <form role='form' method="post" enctype="multipart/form-data" class="col-sm-12" action="{{ route('postAdminArticleTypesAdd') }}">
                    {{ csrf_field() }}
