    ...
    FileInput.prototype = {
        ...
        _initTemplateDefaults: function () {
            ...
            tActions = '{drag}\n' +
                ...
                '</div>';
            //noinspection HtmlUnknownAttribute
            tActionDelete = '<span {dataKey} class="set-main " title="Main Image"><i class="fa fa-star"  aria-hidden="+ true"></i></span>\n' +
        ...
        _initZoomButton: function () {
            ...
            self.$preview.find('.kv-file-zoom').each(function () {
                ...
                self._handler($el, 'click', function () {
                    ...
                    if($('#kvFileinputModal').hasClass('in')){
                        $('#kvFileinputModal').removeClass('in');
                    }else if(!$('#kvFileinputModal').hasClass('in')){
